...
const ContactEmail = () => {
  const handleEmailClick = (e) => {
    e.preventDefault();
    window.location.href = 'mailto:mfee48five@gmail.com';
  };

  return (
    <a href="#" onClick={handleEmailClick}>
      <img src="/icons/icon-mail-white.svg" alt="Email Icon" />
    </a>
  );
};
      ...
      <div className={styles['footer-container']}>
        <div className="row justify-content-between">
          <div className={`${styles.info} col-xl-4`}>
            ...
            <p>
              Eleganza Violin Studio 是一家提供小提琴及其配件產品、小提琴課程、音樂會場地和日常練習場地，以及音樂推廣講座的小提琴音樂工作室。
            </p>
            ...
            <div className="col">
              <div className="row justify-content-between">
                <div className={`${styles.link} col-sm  mb-2`}>
                  ...
                  <span>
                    <img src="/icons/icon-phone-white.svg" alt="Phone Icon" />
                    +886229961786
                  </span>
                  <span>
                    <a href="#">
                      <img src="/icons/icon-message-white.svg" alt="Message Icon" />
                      表單聯繫我們
                    </a>
                  </span>
                </div>
