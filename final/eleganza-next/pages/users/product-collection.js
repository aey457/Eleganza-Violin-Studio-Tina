      ...
      <div class="main">
         ...
         <div class="mainarea-desktop-collection">
            <div class="productcard">
               <a href=""><img src="./images/product_images/6746845_800.jpg" alt="" class="productcardimg"></a> 
               <div class="product-word">
                  <ul class="productcardtitle list-unstyled">
                      <li class="productbranding"><a href="">Karl Höfner</a></li>
                      <li><a class="productname" href="">Allegro 3/4 Violin Outfit</a></li>
                  </ul>
                  <ul class="productcard-function list-unstyled">
                      <li class="productprice">$8,5000</li>
        ...
        <div class="lesson-mobile">
         <div class="btn-mobile">
            <div class="sbtn-selected"><a href="">商品收藏</a></div>
            <div class="sbtn"><a href="">課程收藏</a></div>
         </div>
         <div class="productcard">
            <a href=""><img src="./images/product_images/6746845_800.jpg" alt="" class="productcardimg"></a> 
            <div class="product-word">
